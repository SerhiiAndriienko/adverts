...
export function ModalCard({ selectedCar, setIsModalOpen, isModalOpen }) {
              ...
              <Card key={selectedCar.id}>
                <div>
                  <div style={{ display: 'block' }}>
                    ...
                    <DescriptionPart>
                      {addressArray[1]} | {addressArray[2]} | Id:{' '}
                      {selectedCar.id} | Year: {selectedCar.year} | Type:{' '}
                      {selectedCar.type} | Fuel Consumption{' '}
                      {selectedCar.fuelConsumption} | Engine Size:{' '}
